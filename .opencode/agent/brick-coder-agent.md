---
description: "BRICK Coder — Gherkin into red acceptance tests, red unit tests, then green implementation."
mode: subagent
permission:
  edit: deny
  bash:
    "*": ask
---
<!-- GENERATED from .agents/agents/brick-coder-agent.md by harness-bootstrap — do not edit -->
# brick-coder-agent
