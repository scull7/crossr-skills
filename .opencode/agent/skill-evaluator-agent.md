---
description: "Senior Agent Skills Architect — primary evaluator in the skill remediation GAN."
mode: subagent
permission:
  edit: deny
  bash:
    "*": ask
---
<!-- GENERATED from .agents/agents/skill-evaluator-agent.md by harness-bootstrap — do not edit -->
