---
description: "Second adversary in the AVRIL planning GAN — testability, acceptance-criteria completeness, and failure modes."
mode: subagent
permission:
  edit: deny
  bash:
    "*": ask
---
<!-- GENERATED from .agents/agents/qa-architect-agent.md by harness-bootstrap — do not edit -->
# qa-architect-agent
