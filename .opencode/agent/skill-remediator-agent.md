---
description: "Precision Refiner — the generator half of the skill remediation GAN."
mode: subagent
permission:
  edit: deny
  bash:
    "*": ask
---
<!-- GENERATED from .agents/agents/skill-remediator-agent.md by harness-bootstrap — do not edit -->
