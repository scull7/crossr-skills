---
description: "BRICK Refactorer — behaviour-preserving improvement plus property tests."
mode: subagent
permission:
  edit: deny
  bash:
    "*": ask
---
<!-- GENERATED from .agents/agents/brick-refactorer-agent.md by harness-bootstrap — do not edit -->
