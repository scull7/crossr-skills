...
This skill is the canonical authority on obsessive, pedantic test coverage, error-path verification, and test quality for the code under review written according to its principles.
